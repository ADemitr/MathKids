...
{
    public class DiffMathTaskGen : IMathTaskGenerator
    {
        private int _minNumber = 0;
        private int _maxNumber = 100;
        private Random _random = new Random();

        public DiffMathTaskGen(Random random) => _random = random;

        public DiffMathTaskGen(Random random, int minNumber = 0, int maxNumber = 100) : this(random)
        {
